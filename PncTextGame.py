...
wr01_Sol     = PlayerDoll("솔"      , _hp=800 , _mp=300, _atk=120, _dfs=20, _crt=20, _crd=50 , _avd=5 , _cool=3)
...
sp01_Luna    = PlayerDoll("보름"    , _hp=700 , _mp=500, _atk=80 , _dfs=15, _crt=50, _crd=80 , _avd=25, _cool=3)
